    ...
    <div style={styles.root}>
      ...
      <nav style={{ ...styles.nav, ...(scrolled ? styles.navScrolled : {}) }}>
        <span style={styles.logo}>
          RS<span style={styles.logoDot}>.</span>
        </span>
      ...
      <header style={styles.hero}>
        ...
        <div style={styles.heroContent}>
          <p style={styles.heroEyebrow} className="fade-up-1">
            Data Analyst · ML Enthusiast · MSc Candidate
          </p>
          <h1 style={styles.heroName} className="fade-up-2">
            Rakesh
            <br />
            <span style={styles.heroNameAccent}>Sampathi</span>
          </h1>
          <p style={styles.heroSub} className="fade-up-3">
            Turning raw data into decisions — through Python, SQL, Power BI
            &amp; beyond.
          </p>
          <div style={styles.heroCtas} className="fade-up-4">
            <a
              href="mailto:sampathirakeshreddy@gmail.com"
              style={styles.ctaPrimary}
            >
              Get in Touch
            </a>
            <a
              href="https://github.com/rakeshsampathi"
              target="_blank"
              rel="noreferrer"
      ...
      {/* ABOUT */}
      <section
        ref={(r) => (sectionRefs.current["About"] = r)}
        data-section="About"
        ...
        <div style={styles.container}>
          ...
          <div style={styles.aboutGrid}>
            <div
              style={{
                ...styles.aboutText,
                ...(visible["About"] ? styles.slideIn : {}),
              }}
            >
              <p style={styles.aboutP}>
                I'm a Master's student in{" "}
                <strong style={styles.hl}>
                  Big Data &amp; Business Analytics
                </strong>{" "}
                at FOM Hochschule, Essen. With a background in Computer Science
                Engineering, I bridge technical programming skills with business
                intelligence.
              </p>
              <p style={styles.aboutP}>
                I specialise in building{" "}
                <strong style={styles.hl}>end-to-end data workflows</strong> —
                from raw data cleaning to interactive dashboards — and applying{" "}
                <strong style={styles.hl}>ethical ML methods</strong> to
                real-world problems like bias detection and fairness mitigation.
              </p>
              <p style={styles.aboutP}>
                Currently seeking a{" "}
                <strong style={styles.hl}>Werkstudent position</strong> where I
                can support data-driven decision-making in a professional
                environment.
              </p>
            </div>
      ...
      {/* SKILLS */}
      <section
        ref={(r) => (sectionRefs.current["Skills"] = r)}
        data-section="Skills"
            ...
            {Object.entries(SKILLS).map(([cat, items], ci) => (
              <div
                ...
                style={{
                  ...
                  ...(visible["Skills"] ? styles.fadeIn : styles.invisible),
                }}
              >
      ...
      {/* PROJECTS */}
      <section
        ref={(r) => (sectionRefs.current["Projects"] = r)}
            ...
            {PROJECTS.map((p, i) => (
              <div
                ...
                style={{
                  ...
                  ...(visible["Projects"] ? styles.fadeIn : styles.invisible),
                }}
              >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  style={{ ...styles.projectLink, color: p.color }}
                >
                  View on GitHub ↗
                </a>
              </div>
      ...
      {/* EDUCATION & CERTS */}
      <section
        ref={(r) => (sectionRefs.current["Education"] = r)}
      ...
      <footer style={styles.footer}>
        ...
        <div style={styles.footerLinks}>
          ...
          <a
            href="https://www.linkedin.com/in/rakesh-reddy-sampathi-b2b787217/"
            target="_blank"
            rel="noreferrer"
            style={styles.footerLink}
          >
          ...
          <a
            href="https://leetcode.com/rakeshreddysampathi"
            target="_blank"
            rel="noreferrer"
            style={styles.footerLink}
          >
        ...
        <p style={{ ...styles.footerText, opacity: 0.3, marginTop: 8 }}>
          +49 17682324442
        </p>
      </footer>
    </div>
  ...
  return (
    <div
      style={{
        ...
        ...(visible ? styles.fadeIn : styles.invisible),
      }}
    >
...
const styles = {
  ...
  heroGlow: {
    ...
    borderRadius: "50%",
    background:
      "radial-gradient(circle, rgba(0,198,167,0.12) 0%, transparent 70%)",
    pointerEvents: "none",
  },
  heroGrid: {
    position: "absolute",
  ...
  heroNameAccent: {
    WebkitTextStroke: "2px rgba(0,198,167,0.7)",
    color: "transparent",
  },
  heroSub: {
    fontSize: 18,
  ...
  heroOrb: {
    ...
    borderRadius: "50%",
    background:
      "radial-gradient(circle at 40% 40%, rgba(0,198,167,0.15), rgba(249,115,22,0.08), transparent 70%)",
